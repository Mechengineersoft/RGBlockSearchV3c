...
import { LogOut, Search, Loader2, Mic, MicOff, ArrowLeft, FileText } from "lucide-react";
          ...
          <CardContent className="p-1">
            ...
            <div className="flex justify-end gap-2 mt-2 mb-4">
              <Button 
                variant="outline" 
                size="sm" 
                onClick={() => setLocation('/ecol')} 
                className="h-9 flex gap-1 sm:gap-2 items-center bg-teal-100 hover:bg-teal-200 text-teal-800 hover:text-teal-900 border-teal-200 hover:border-teal-300 px-1.5 sm:px-2 md:px-3 min-w-fit whitespace-nowrap"
              >
